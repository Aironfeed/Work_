...
public class PlayerController : MonoBehaviour
{
    ...
    private Mobailcontroler mcontrol;

    // Use this for initialization
    void Start()
    {
        mcontrol = GameObject.FindGameObjectWithTag("joystick").GetComponent<Mobailcontroler>();
    ...
    void Update()
    {
        if (!IsDead && mIsControlEnabled)
        {
            ...
            Vector3 move =mcontrol.Vertical() * camForward_Dir + mcontrol.Horizontal() * Camera.main.transform.right;
